// Import images
import Image1 from '../images/club_4_horse/1.png';
import Image2 from '../images/club_4_horse/2.png';
import Image3 from '../images/club_4_horse/3.png';
import Image4 from '../images/club_4_horse/4.png';
...
export const clubProjectData = {
	ProjectHeader: {
		title: 'Клуб 4 коней',
		publishDate: '10 Апреля, 2024',
		tags: 'Landing',
	},
	ProjectImages: [
		{
	...
	ProjectInfo: {
		...
		CompanyInfo: [
			{
				...
				title: 'Ссылка на GIT',
				details: 'репозиторий',
				url: 'https://github.com/Melkii01/club_4_horse',
			},
			{
				id: 2,
				title: 'Ссылка на сайт',
				details: 'сайт',
				url: 'https://melkii01.github.io/club_4_horse/',
			},
		],
		...
		ProjectDetails: [
			{
				id: 1,
				details: 'Лэндинг сайт для ознакомления с клубом.'
			},
			{
				id: 2,
				details:'Простой одностраничный сайт, с бегущей строкой, слайдером и каруселью, реализованных на нативном JS.'
			},
			{
				id: 3,
