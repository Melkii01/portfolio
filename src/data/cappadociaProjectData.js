// Import images
import Image1 from '../images/cappadocia/1.png';
import Image2 from '../images/cappadocia/2.png';
import Image3 from '../images/cappadocia/3.png';
...
export const cappadociaProjectData = {
	ProjectHeader: {
		title: 'Каппадокия',
	...
	ProjectInfo: {
		...
		CompanyInfo: [
			{
				...
				title: 'Ссылка на GIT',
				details: 'репозиторий',
				url: 'https://github.com/Melkii01/cappadocia',
			},
			{
				id: 2,
				title: 'Ссылка на сайт',
				details: 'сайт',
				url: 'https://melkii01.github.io/cappadocia/#',
			},
		],
		...
		ProjectDetails: [
			{
				id: 1,
				details: 'Лэндинг сайт для подбора туров.'
			},
			{
				id: 2,
